function buildQueryURL() {
    ...
    var queryParams = { "appid": "b64444d674d6e71de86ec3160f69f6b7" };

    queryParams.q = $("#citySearch")
        .val()
        .toLowerCase()
        .trim();
...
function updatePage(cityData) {
    ...
    var uvQueryParams = { "appid": "b64444d674d6e71de86ec3160f69f6b7" };
